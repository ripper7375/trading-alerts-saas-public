This documents indicate files that are created / modified / updated as result of adding indicators to PRO Plan :

=====================================================

The complete list of files modified/created in this session for Part 6:
...
The complete list of files modified/created in this session for Part 3, 4, 7 and 9:
