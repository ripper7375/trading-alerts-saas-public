...
> — the order's own scope defers it to Session **4A-W4** (it needs the `4A-W4` audit findings to be
> meaningful). F44–F46 were registered ahead of Session 4A-7a because that session needed them at
> CONFIRM time.
>
