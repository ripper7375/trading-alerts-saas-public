...
## Phase 9 Prompt: Deployment & Cutover

```
# Part 20 - Phase 9: Deployment & Cutover

## Context
I'm implementing Part 20 of Trading Alerts SaaS. Phases 1-8 are complete and all tests passing.

This phase handles deployment to production and cutover from Part 6.

Please refer to the attached documents:
- `part-20-implementation-plan.md` - Phase 9 details and rollback plan
...
# - Verify MQL5 Services running

echo "Step 2: Enable maintenance mode..."
# - Call maintenance API endpoint
# - Wait for active requests to complete

echo "Step 3: Stop Part 6 Flask service..."
# - Stop Flask container/service
# - Verify it's stopped

echo "Step 4: Run database migrations..."
# - Apply any pending PostgreSQL migrations
# - Verify schema is correct

echo "Step 5: Deploy Part 20 API..."
# - Deploy Next.js with new routes
# - Verify deployment successful

echo "Step 6: Start sync script..."
# - Start sync cron job (every 30s)
# - Verify first sync completes

echo "Step 7: Verify data flowing..."
# - Check PostgreSQL has recent data
# - Check Redis cache populated
# - Check API returns data

echo "Step 8: Run smoke tests..."
# - Test /api/health
# - Test /api/indicators/EURUSD/H1
...
### 2. `scripts/rollback-to-part6.sh`
...
echo "========================================="
echo "Part 20 Rollback Script"
echo "========================================="

echo "WARNING: Rolling back to Part 6 Flask service"
...
echo "Step 3: Restart Flask service..."
# - Start Flask container
# - Verify it's healthy

echo "Step 4: Update API routing..."
# - Route /api/indicators to Flask
# - Keep Next.js for other routes

echo "Step 5: Verify Flask responding..."
...
### Infrastructure
- [ ] PostgreSQL on Railway provisioned
- [ ] Redis on Railway provisioned
...
- [ ] MQL5 DataCollector service installed on each
- [ ] SQLite database created
- [ ] Sync script tested

### Code
- [ ] All Phase 1-8 code merged to main
...
- [ ] Stop Flask service
- [ ] Deploy Next.js with Part 20 routes
- [ ] Start sync script
- [ ] Verify data flowing
- [ ] Run smoke tests
...
- [ ] Verify chart accuracy matches MT5
- [ ] Check sync script logs
- [ ] Confirm Redis cache hit rate
- [ ] Archive Part 6 code (don't delete yet)
...
Add Part 20 environment variables:
...
# Part 20 - Sync Script (Contabo VPS only)
...
- Keep Part 6 Flask service artifacts for 30 days
...
After creating all files, commit with message:
```
chore(deploy): add Part 20 deployment and rollback scripts

- Add deployment script with step-by-step instructions
...
2. If stable, create PR to remove Part 6 Flask code
3. Update architecture documentation
4. Close Part 20 implementation task
```
...
| 9 | Deployment & Cutover | 4 script/doc files | 2 hours |

**Total: ~45 files, 20-27 hours of implementation**
