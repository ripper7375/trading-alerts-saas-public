        ...
        headers: [
          ...
          // A stricter CSP with nonces should be implemented for production
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.googleusercontent.com https://*.githubusercontent.com https://*.stripe.com https://*.public.blob.vercel-storage.com https://i.ytimg.com",
              "font-src 'self' data:",
              "connect-src 'self' https://api.stripe.com https://checkout.stripe.com https://operation-service-production.up.railway.app wss://operation-service-production.up.railway.app http://localhost:3001 ws://localhost:3001 https://chat-api.davintrade.app wss://chat-api.davintrade.app https://*.vercel-analytics.com https://ipapi.co",
              "frame-src 'self' https://js.stripe.com https://checkout.stripe.com https://www.youtube-nocookie.com",
