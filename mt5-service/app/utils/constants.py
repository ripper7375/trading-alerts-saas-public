...
# ============================================================================
# NOTE: Custom indicators are NOT available via MT5 Python API
# ============================================================================
# The MT5 Python API's iCustom() function does not work reliably.
# Part 6 (Flask MT5 Service) ONLY provides raw OHLCV data.
#
# For indicators and technical analysis, use Part 20 (SQLite-Sync Script)
# which processes indicator data separately.
# ============================================================================
