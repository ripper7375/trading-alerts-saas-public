...
export class DashboardPage {
  ...
  constructor(page: Page) {
    ...
    // Header elements - using data-testid attributes from header.tsx
    ...
    // User menu items - using data-testid from header.tsx
    this.logoutButton = page.locator('[data-testid="logout-button"]');
    this.profileLink = page.locator('[data-testid="menu-profile"]');
    this.settingsLink = page.locator('[data-testid="menu-settings"]');
