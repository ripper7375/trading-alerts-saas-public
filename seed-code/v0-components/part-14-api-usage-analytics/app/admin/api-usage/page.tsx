...
export default function ApiUsageAnalyticsPage() {
  ...
  const getMethodBadge = (method: string) => {
    ...
    return (
      <Badge
        className={`${variants[method] || 'bg-gray-100 text-gray-700'} border-0`}
      >
        {method}
      </Badge>
    );
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-3xl font-bold text-foreground">
                    {freeTierCalls.toLocaleString()}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {freePercentage}% of total
                  </p>
                </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-start justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-3xl font-bold text-foreground">
                    {proTierCalls.toLocaleString()}
                  </p>
                  <p className="text-sm text-muted-foreground">
                    {proPercentage}% of total
                  </p>
                </div>
