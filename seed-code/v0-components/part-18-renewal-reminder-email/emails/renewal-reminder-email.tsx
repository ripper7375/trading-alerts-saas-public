        ...
        <Container style={containerStyle}>
          ...
          <Section style={heroStyle}>
            ...
            <Text style={subheadlineStyle}>
              Renew now to keep your PRO features
            </Text>
          </Section>
          ...
          <Section style={featuresContainerStyle}>
            <Heading style={featuresHeadingStyle}>
              What You'll Lose Without PRO:
            </Heading>
            <Text style={featureItemStyle}>
              <span style={iconRedStyle}>✗</span> Access to 15 symbols
              (downgrade to 5)
            </Text>
            <Text style={featureItemStyle}>
              <span style={iconRedStyle}>✗</span> Access to 9 timeframes
              (downgrade to 3)
            </Text>
            <Text style={featureItemStyle}>
              <span style={iconRedStyle}>✗</span> 20 alerts capacity (downgrade
              to 5)
            </Text>
            <Text style={featureItemStyle}>
          ...
          <Section style={ctaContainerStyle}>
            <Button
              style={buttonStyle}
              href="https://tradingalerts.com/checkout"
            >
              Renew Subscription Now
            </Button>
            <Text style={alternativeTextStyle}>
              <Link
                href="https://tradingalerts.com/settings/billing"
                style={alternativeLinkStyle}
              >
          ...
          <Section style={footerStyle}>
            ...
            <Text style={unsubscribeStyle}>
              <Link
                href="https://tradingalerts.com/unsubscribe"
            ...
            <Section style={socialContainerStyle}>
              <Row>
                <Column align="center">
                  ...
                  <Link
                    href="https://facebook.com/tradingalerts"
                    style={socialLinkStyle}
                  >
                    <span style={socialIconStyle}>📘</span>
                  </Link>
