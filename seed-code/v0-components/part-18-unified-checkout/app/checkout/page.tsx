...
const paymentMethodInfo: Record<
  PaymentMethod,
  { name: string; icon: any; badge: string; available: string }
> = {
...
function CheckoutPageContent() {
  ...
  const handleApplyCode = () => {
    ...
    if (
      discountCode.toLowerCase() === 'affiliate10' ||
      discountCode.toLowerCase().startsWith('aff')
    ) {
      setCodeApplied(true);
      setCodeError('');
    } else {
                  ...
                  {codeApplied && !codeError && (
                    <div className="mt-3 p-3 bg-green-50 rounded-lg space-y-1">
                      <div className="text-sm text-green-700 font-medium">
                        ✅ Code {discountCode.toUpperCase()} applied! Save{' '}
                        {discountPercent}%
                      </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    {selectedPlan === '3day' ? '3 days' : '30 days'}
                  </p>
                  ...
                  {codeApplied && selectedPlan === 'monthly' && (
                    <div className="flex justify-between text-sm">
                      <span className="text-green-600">
                        Affiliate Discount ({discountPercent}% off)
                      </span>
