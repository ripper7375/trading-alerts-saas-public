...
export default function AffiliateDashboardPage() {
  ...
  const { commissionPercent, discountPercent, calculateDiscountedPrice } =
    useAffiliateConfig();
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
            ...
            <CardContent>
              ...
              <Progress
                value={(activeCodes / totalCodes) * 100}
                className="h-2 mb-2"
              />
              <p className="text-xs text-gray-600">
                {totalCodes - activeCodes} available to distribute
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-violet-50 border-purple-200">
            ...
            <CardContent>
              ...
              <p className="text-xs text-gray-600 mt-2">
                {codesUsed} sales × ${commissionAmount.toFixed(2)} (
                {commissionPercent}%)
              </p>
            </CardContent>
          </Card>
              ...
              <div className="mt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-sm font-semibold">
                    {Math.round((activeCodes / totalCodes) * 100)}% active
                  </span>
                </div>
                <Progress
                  value={(activeCodes / totalCodes) * 100}
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-1">
                  Current Commission Rate: {commissionPercent}%
                </h3>
                <p className="text-sm text-gray-600">
                  You earn ${commissionAmount.toFixed(2)} per sale (regular
                  price ${regularPrice.toFixed(2)} with {discountPercent}%
                  discount = ${discountedPrice.toFixed(2)}). Keep sharing your
                  codes to maximize your earnings!
                </p>
              </div>
            </div>
          </CardContent>
