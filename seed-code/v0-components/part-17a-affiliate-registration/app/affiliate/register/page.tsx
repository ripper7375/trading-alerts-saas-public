...
export default function AffiliateRegistrationPage() {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    toast({
      ...
      description:
        'Welcome to the affiliate program! You will receive 15 discount codes on the 1st of next month.',
    });
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600">
                Earn ${commissionAmount} for every PRO upgrade using your codes
              </p>
            </div>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder={getPaymentPlaceholder(paymentMethod)}
                          rows={4}
                          {...field}
                        />
                      </FormControl>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">
                      15 Discount Codes Monthly
                    </h3>
                    <p className="text-sm text-gray-600">
                      Automatically distributed on the 1st of each month. No
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Earn {commissionPercent}% of each discounted PRO
                      subscription ({discountPercent}% off applies to customers)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      View your earnings dashboard 24/7. Track active codes,
                      used codes, and pending commissions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Accounting-style reports emailed automatically. Track
                      opening/closing balances like a pro.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Get paid whenever you request. No waiting until you reach
                      $100 or $500.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-purple-50 rounded-lg p-4 text-center">
                  <p className="text-sm font-medium text-gray-900">
                    Customer uses your discount code
                  </p>
                </div>
                ...
                <div className="bg-blue-50 rounded-lg p-4 text-center">
                  <p className="text-sm font-medium text-gray-900">
                    They get {discountPercent}% off
                  </p>
                  <p className="text-xs text-gray-600 mt-1">
                    ($29.00 → ${discountedPrice.toFixed(2)}/month)
                  </p>
                </div>
                ...
                <div className="bg-green-50 rounded-lg p-4 text-center">
                  ...
                  <p className="text-xs text-gray-600 mt-1">
                    ({commissionPercent}% of discounted price)
                  </p>
                </div>
