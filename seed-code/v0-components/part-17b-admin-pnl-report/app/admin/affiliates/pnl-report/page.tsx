      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          <p className="text-sm text-gray-500">
            Admin &gt; Affiliates &gt; P&L Report
          </p>
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <h1 className="text-3xl font-bold text-gray-900">
              Profit & Loss Report - Affiliate Program
            </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    ${paidCommissions.toFixed(0)} paid + $
                    {pendingCommissions.toFixed(0)} pending
                  </p>
                </CardContent>
              </Card>
              ...
              <CardContent>
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 pl-4">
                      ...
                      <div className="text-right">
                        {totalSales} × ${regularPrice.toFixed(2)} = $
                        {grossRevenue.toLocaleString()}
                      </div>
                  ...
                  <div className="text-sm text-gray-500 bg-blue-50 p-3 rounded border border-blue-200">
                    ...
                    <p>
                      • Discounted Price: ${discountedPrice.toFixed(2)} (was $
                      {regularPrice})
                    </p>
                    ...
                    <AccordionContent>
                      <div className="space-y-2">
                        {dailyBreakdown.map((day, index) => (
                          <div
                            key={index}
                            className="grid grid-cols-4 gap-2 py-2 border-b last:border-0"
                          >
                            ...
                            <div className="text-right text-gray-500">
                              -${day.commissions.toFixed(2)} comm
                            </div>
                          </div>
                        ))}
                      </div>
