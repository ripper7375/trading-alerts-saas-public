              ...
              <div
                className={cn(
                  ...
                  message.role === 'user'
                    ...
                    : 'bg-muted/50 border-border/50 rounded-tl-sm border text-foreground'
                )}
              >
                {/* AI Label inside bubble */}
                {message.role === 'assistant' && (
                  <div className="text-primary/70 mb-1 text-[10px] font-bold uppercase tracking-wider">
                    DavinTrade AI
                  </div>
                )}
      ...
      <div className="border-t bg-background p-4">
        <div className="relative mx-auto max-w-3xl">
          ...
          <textarea
            ...
            className="bg-muted/40 focus:ring-primary/20 placeholder:text-muted-foreground/60 min-h-[50px] w-full resize-none rounded-xl border border-input py-3 pl-12 pr-12 text-sm shadow-inner focus:border-primary focus:outline-none focus:ring-2"
            rows={1}
          />
