    ...
    <div className="flex h-screen w-full flex-col overflow-y-auto bg-slate-50 text-slate-900 select-none dark:bg-[#06070a] dark:text-slate-100">
      ...
      <main className="mx-auto w-full max-w-7xl flex-1 space-y-6 p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <Card className="space-y-4 border-amber-500/30 bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-slate-100 p-6 shadow-sm md:col-span-2 dark:from-[#0c0f1e] dark:via-[#111526] dark:to-[#090b14]">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-amber-500/40 bg-amber-500/20 text-amber-600 dark:text-amber-400">
          ...
          <Card className="flex flex-col justify-between space-y-4 border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800/80 dark:bg-[#090b14]/90">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <ShieldCheck className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />
                <h4 className="text-xs font-bold tracking-wider text-slate-900 uppercase dark:text-slate-200">
            ...
            <Link href="/help">
              <Button
                variant="outline"
                size="sm"
                className="dark:border-slate-750 w-full border-slate-300 bg-slate-50 text-xs text-slate-800 hover:bg-slate-100 dark:bg-transparent dark:text-slate-300 dark:hover:bg-slate-800"
              >
          ...
          <Table>
            ...
            <TableBody>
              {payouts.map((p) => (
                ...
                >
                  <TableCell className="font-mono text-xs font-bold text-slate-800 dark:text-slate-300">
                    {p.id}
                  </TableCell>
        ...
        <Card className="border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800/80 dark:bg-[#090b14]/90">
          ...
          <div className="grid grid-cols-1 gap-4 text-xs sm:grid-cols-3">
            ...
            <div className="flex items-center gap-2">
              <Badge className="border-cyan-500/40 bg-cyan-500/15 text-[10px] text-cyan-700 dark:bg-cyan-500/20 dark:text-cyan-400">
                {t('PROCESSING')}
              </Badge>
              <span className="text-slate-600 dark:text-slate-400">
