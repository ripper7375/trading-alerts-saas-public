    ...
    <div className="flex h-screen w-full flex-col overflow-y-auto bg-slate-50 text-slate-900 select-none dark:bg-[#06070a] dark:text-slate-100">
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 space-y-6 p-4 md:p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Account Statistics */}
          <Card className="space-y-4 border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800/80 dark:bg-[#090b14]/90">
          ...
          <Card className="flex flex-wrap items-center justify-between gap-4 border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800/80 dark:bg-[#090b14]/90">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-amber-500/30 bg-amber-500/10 text-amber-600 dark:text-amber-400">
            ...
            <Link href="/affiliate/dashboard/payouts">
              <Button
                ...
                variant="outline"
                size="sm"
                className="dark:border-slate-750 border-slate-300 bg-slate-50 text-xs text-slate-800 hover:bg-slate-100 dark:bg-transparent dark:text-slate-300 dark:hover:bg-slate-800"
              >
