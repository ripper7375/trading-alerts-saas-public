  ...
  return (
    <div className="flex min-h-screen flex-col bg-[#050609] text-slate-100">
      ...
      <main className="container mx-auto max-w-5xl flex-1 px-4 py-16 md:px-6">
        ...
        <Card className="mx-auto mt-10 max-w-xl border-slate-800/80 bg-[#090b14]/90 p-8 text-center backdrop-blur-xl">
          <CardContent className="space-y-4 p-0">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full border border-amber-500/30 bg-amber-500/10">
              <Users className="h-7 w-7 text-amber-400" aria-hidden="true" />
            </div>
