    ...
    <div className="space-y-6">
        ...
        <CardContent>
          <div className="flex flex-wrap gap-4 text-xs">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-slate-300">{t('Database')}</span>
            </div>
            <div className="flex items-center gap-2">
              <span
            ...
            {HEALTH.failedTransactions > 0 && (
              <Badge className="border-rose-500/40 bg-rose-500/15 text-[10px] text-rose-300">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Card className="border-slate-800/80 bg-[#090c14]">
          ...
          <CardContent>
            <div className="font-mono text-2xl font-extrabold text-emerald-400 sm:text-3xl">
        ...
        <Card className="border-slate-800/80 bg-[#090c14]">
          ...
          <CardContent>
            <div className="font-mono text-2xl font-extrabold text-amber-400 sm:text-3xl">
        ...
        <Card className="border-slate-800/80 bg-[#090c14]">
          <CardHeader className="pb-2">
            <CardDescription className="flex items-center gap-2 text-slate-400">
              {t('Payment Batches')}
              <Badge className="border-blue-500/40 bg-blue-500/15 text-[9px] text-blue-300">
                {SUMMARY.batches.successRate.toFixed(1)}% {t('success')}
              </Badge>
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-extrabold text-slate-100 sm:text-3xl">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
        <Card className="border-slate-800/80 bg-[#090c14]">
          ...
          <CardContent className="space-y-2">
            <Link
              ...
              className="flex items-center gap-2.5 rounded-xl border border-slate-800 bg-slate-800/40 px-4 py-3 text-xs font-semibold text-slate-200 transition-colors hover:bg-slate-800"
            >
            ...
            <Link
              ...
              className="flex items-center gap-2.5 rounded-xl border border-rose-500/20 bg-rose-500/5 px-4 py-3 text-xs font-semibold text-rose-300 transition-colors hover:bg-rose-500/15"
            >
        ...
        <Card className="border-slate-800/80 bg-[#090c14]">
          ...
          <CardContent>
            <div className="mb-4 font-mono text-4xl font-extrabold text-emerald-400">
        ...
        <Card className="border-slate-800/80 bg-[#090c14]">
          ...
          <CardContent>
            <div className="mb-4 font-mono text-4xl font-extrabold text-blue-400">
