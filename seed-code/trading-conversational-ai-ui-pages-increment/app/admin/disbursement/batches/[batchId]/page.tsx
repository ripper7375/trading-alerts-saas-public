    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <h1 className="mt-1 flex items-center gap-3 text-2xl font-bold text-slate-900 sm:text-3xl dark:text-slate-100">
            {batch.batchNumber}
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-4 text-xs sm:grid-cols-2">
            <div>
              ...
              <p className="mt-0.5 text-slate-900 dark:text-slate-200">
                {t(batch.provider)}
              </p>
            </div>
            <div>
        ...
        <Card className="border-slate-200 bg-white shadow-sm dark:border-slate-800/80 dark:bg-[#090c14]">
          ...
          <CardContent className="space-y-2">
            {batch.auditLogs.map((log) => (
              <div
                key={log.id}
                className="flex items-start gap-3 rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-transparent dark:bg-slate-800/40"
              >
