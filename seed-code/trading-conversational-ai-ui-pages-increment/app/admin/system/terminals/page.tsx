        ...
        <div className="grid gap-4 md:grid-cols-3">
          {terminals.map((node) => (
            ...
            >
              ...
              <div className="space-y-1.5 border-t border-b border-slate-200 py-3 text-xs dark:border-slate-800/80">
              ...
              <Button
                ...
                className="w-full border-slate-300 bg-slate-50 text-xs text-rose-700 hover:border-rose-500/40 hover:bg-rose-50 dark:border-slate-700 dark:bg-[#06080e] dark:text-rose-300 dark:hover:bg-rose-950/30"
              >
                <Power
