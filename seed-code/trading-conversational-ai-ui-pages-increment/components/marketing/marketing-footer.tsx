...
export function MarketingFooter() {
  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-50 text-slate-600 dark:border-slate-800/80 dark:bg-[#040508] dark:text-slate-400">
      <div className="container mx-auto px-4 py-12 md:px-6">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-5">
          ...
          <div className="col-span-2 space-y-4">
            <Link href="/" className="flex items-center space-x-3">
              ...
              <span className="bg-gradient-to-r from-amber-600 to-amber-500 bg-clip-text text-lg font-black text-transparent dark:from-amber-400 dark:to-amber-200">
                DavinTrade AI
              </span>
            </Link>
        ...
        <div className="mt-10 border-t border-slate-200 pt-6 text-center text-[11px] leading-relaxed text-slate-500 dark:border-slate-800/60">
