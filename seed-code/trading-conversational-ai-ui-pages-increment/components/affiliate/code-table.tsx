...
export default function CodeTable() {
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-xl select-none dark:border-slate-800 dark:bg-[#090c14]">
      <div className="flex items-center justify-between border-b border-slate-200 pb-3 dark:border-slate-800">
        <h3 className="flex items-center gap-1.5 text-xs font-bold tracking-wider text-slate-900 uppercase dark:text-slate-200">
          ...
          >
            <div>
              <div className="flex items-center gap-2">
                <span className="font-mono text-sm font-extrabold text-amber-700 dark:text-amber-300">
                  {c.code}
                </span>
              ...
              <div className="mt-0.5 font-mono text-[11px] text-slate-600 dark:text-slate-400">
                {c.link}
              </div>
            </div>
            ...
            <div className="flex w-full items-center justify-between gap-3 sm:w-auto sm:justify-end">
              ...
              <Button
                ...
                className="dark:border-slate-750 h-7 border-slate-300 bg-slate-100 text-[10px] text-slate-800 hover:bg-slate-200 dark:bg-slate-800 dark:text-slate-200"
              >
                {copiedId === c.code ? (
                  <>
                  ...
                  <>
                    <Copy className="mr-1 h-3 w-3 text-amber-600 dark:text-amber-400" />{' '}
                    {t('Copy Link')}
                  </>
                )}
              </Button>
