...
export function LandingFooter() {
  ...
  return (
    <footer className="border-t border-slate-200 bg-slate-50 py-12 text-xs text-slate-500 dark:border-slate-800 dark:bg-[#040508] dark:text-slate-400">
      <div className="container mx-auto space-y-8 px-4 md:px-6">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="space-y-2">
            <div className="mb-2 text-xs font-bold tracking-wider text-slate-800 uppercase dark:text-slate-200">
              {t('Platform & Terminal')}
            </div>
        ...
        {/* Bottom Disclaimer */}
        <div className="space-y-2 border-t border-slate-200 pt-6 text-[11px] leading-relaxed text-slate-500 dark:border-slate-800/80 dark:text-slate-400">
          <p>
          ...
          <div className="flex flex-col items-center justify-between pt-4 text-slate-500 sm:flex-row dark:text-slate-400">
            <span>
