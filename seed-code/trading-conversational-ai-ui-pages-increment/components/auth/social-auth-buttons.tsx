  ...
  return (
    <div className="space-y-2.5">
      <button
        ...
        disabled={isLoading}
        className="border-slate-750 flex w-full items-center justify-center gap-2 rounded-lg border bg-[#0d1019] px-4 py-2.5 text-xs font-semibold text-slate-200 transition-colors hover:bg-slate-800/60 disabled:cursor-not-allowed disabled:opacity-50"
      >
      ...
      <button
        ...
        disabled={isLoading}
        className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-800 bg-slate-950 px-4 py-2.5 text-xs font-semibold text-white transition-colors hover:bg-slate-900 disabled:cursor-not-allowed disabled:opacity-50"
      >
