    ...
    return (
      <div className="mx-auto max-w-4xl space-y-6 select-none">
        <div className="space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-xl dark:border-slate-800/80 dark:bg-[#090c14]">
          <div className="flex flex-col items-start justify-between gap-4 border-b border-slate-200 pb-4 sm:flex-row sm:items-center dark:border-slate-800">
            <div>
              <Badge className="border-slate-200 bg-slate-100 font-mono text-[10px] text-slate-700 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300">
                🔒 {t('FREE PLAN')}
              </Badge>
          ...
          <div className="rounded-xl border border-amber-500/30 bg-amber-500/10 p-4">
            <h3 className="mb-3 text-xs font-extrabold text-amber-700 dark:text-amber-300">
            ...
            <Link href="/pricing">
              <Button
                variant="outline"
                className="mt-4 w-full border-amber-500/40 bg-amber-500/10 text-xs text-amber-700 hover:bg-amber-500/20 dark:text-amber-300"
              >
    ...
    <div className="mx-auto max-w-4xl space-y-6 select-none">
      ...
      <div className="space-y-4 rounded-2xl border border-amber-500/40 bg-gradient-to-r from-amber-500/10 via-amber-500/5 to-slate-100 p-6 shadow-xl dark:from-[#0c0f18] dark:via-[#121624] dark:to-[#0d0f17]">
        ...
        <div className="grid grid-cols-1 gap-4 text-xs sm:grid-cols-3">
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-[#06080e]">
            <span className="text-[10px] text-slate-500 dark:text-slate-400">
              {t('Current Billing Rate')}
            </span>
            <div className="font-mono text-base font-extrabold text-amber-700 dark:text-amber-300">
      ...
      <div className="space-y-3 overflow-hidden rounded-2xl border border-slate-200 bg-white p-4 shadow-xl dark:border-slate-800 dark:bg-[#090c14]">
        <h3 className="flex items-center justify-between text-xs font-bold tracking-wider text-slate-800 uppercase dark:text-slate-200">
          ...
          {invoices.map((inv) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 text-right">
                ...
                <Badge className="border-emerald-500/40 bg-emerald-500/15 font-mono text-[9px] text-emerald-700 dark:text-emerald-400">
                  {inv.status}
                </Badge>
                <Button
                  variant="ghost"
