  ...
  var Z = (function t() {
    ...
    const rt = r.createElement('form'),
      ...
      at = function () {
        ...
        if (!ot || ot !== e) {
          if (
            ...
            (Ze = E(e, 'ALLOWED_NAMESPACES')
              ? S({}, e.ALLOWED_NAMESPACES, d)
              : Je),
            (Ye = E(e, 'ADD_URI_SAFE_ATTR')
              ? S(w(je), e.ADD_URI_SAFE_ATTR, nt)
              : je),
            (We = E(e, 'ADD_DATA_URI_TAGS')
              ? S(w(Ge), e.ADD_DATA_URI_TAGS, nt)
              : Ge),
            ...
            e.FORBID_CONTENTS &&
              (ze === Be && (ze = w(ze)), S(ze, e.FORBID_CONTENTS, nt)),
            Pe && (ge['#text'] = !0),
      ...
      At = function (e) {
        ...
        if (!ge[n] || _e[n]) {
          if (!_e[n] && bt(n)) {
            if (Ae.tagNameCheck instanceof RegExp && A(Ae.tagNameCheck, n))
              return !1;
      ...
      _t = function (e, t, n) {
        if (Ie && ('id' === t || 'name' === t) && (n in r || n in rt))
          return !1;
        if (Se && !be[t] && A(me, t));
        else if (Ne && A(fe, t));
        else if (!ye[t] || be[t]) {
    ...
    return (
      (o.sanitize = function (e) {
        let t =
          ...
          l = null;
        if (
          (($e = !e), $e && (e = '\x3c!--\x3e'), 'string' != typeof e && !yt(e))
        ) {
        ...
        if (
          (xe || at(t), (o.removed = []), 'string' == typeof e && (Fe = !1), Fe)
        ) {
          if (e.nodeName) {
          ...
          if (!Ce && !De && !Le && -1 === e.indexOf('<'))
            return ee && Oe ? ee.createHTML(e) : e;
          if (((n = ht(e)), !n)) return Ce ? null : Oe ? te : '';
        }
        n && ve && pt(n.firstChild);
        const c = gt(Fe ? e : n);
        for (; (i = c.nextNode()); )
          At(i) || (i.content instanceof s && St(i.content), Nt(i));
        if (Fe) return e;
        if (Ce) {
          if (ke)
