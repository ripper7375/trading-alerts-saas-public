...
|  **39**   | **Affiliate Payout Status**   | `/affiliate/dashboard/payouts`         | `app/affiliate/dashboard/payouts/page.tsx`            |       AF, AP       | Timeline progress tracker for Wise disbursements.                                                                                                                                                                              |
|  **40**   | **Affiliate Payment Setup**   | `/affiliate/dashboard/profile/payment` | `app/affiliate/dashboard/profile/payment/page.tsx`    |       AF, AP       | Mobile form collecting the affiliate's Wise payout email.                                                                                                                                                                      |
...
|  **45**   | **Affiliate Registration**    | `/affiliate/register`                  | `app/affiliate/register/page.tsx`                     |     NL, FT, PT     | Single-step partner onboarding form (referral code + Wise payout email); account activates immediately, no verification gate.                                                                                                  |
