//+------------------------------------------------------------------+
//|                          SimpleDataCollector_v2.27_API_GATEWAY.mq5|
...
// Version 2.27-API-Gateway Changelog (from v2.26):
// - SCHEMA UPDATE (61 columns): Added "symbol" as column 2 (after timestamp)
//   This makes each row self-describing and supports multi-symbol queries
//   Database structure: timestamp, symbol, open, high, low, close, volume, timeframe, ...
// - COLUMN RENAME: Changed "ema_26" to "ema" for consistency with other MAs (tema, hrma, smma)
//   The period (26) is configurable in MQ5, so removing it from column name
// - All v2.26 features preserved (Dual TEMA High/Low, Pinbar Detection, circuit breaker, etc.)
...
{
   Print("========================================");
   Print("SimpleDataCollector v2.27-API-Gateway");
   Print("========================================");
