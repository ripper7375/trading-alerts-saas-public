 ...
 * YouTube URL Helpers
 *
 * Pure, no-I/O helpers for the Academy tutorials feature: parse an admin-
 * submitted YouTube URL down to its 11-character video ID once at write
 * time, then derive thumbnail/embed URLs from that ID everywhere else so
 * render paths never re-parse a raw URL.
 *
