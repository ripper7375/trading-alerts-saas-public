...
/**
 * `/alerts`, `/alerts/new`, `/alerts/[id]/edit` layout -- see
 * app/dashboard/layout.tsx's own doc comment for why this moved out of
 * `app/(dashboard)/` (Deviation 6/7 extended, same reasoning).
 *
 * Protected route - requires valid session.
 */
export default async function AlertsLayout({
  children,
}: AlertsLayoutProps): Promise<React.ReactElement> {
