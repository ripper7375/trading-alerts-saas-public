...
export default function NotFound() {
  ...
  return (
    <div className="flex min-h-screen select-none flex-col items-center justify-center bg-slate-50 p-4 text-center dark:bg-[#07090e]">
      <div className="max-w-md space-y-4 rounded-2xl border border-slate-200 bg-white p-8 shadow-2xl dark:border-slate-800 dark:bg-[#0c0f18]">
        ...
        <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:justify-center">
          <Button
            onClick={() => router.back()}
            variant="outline"
            className="h-9 w-full border-slate-300 bg-transparent text-xs font-bold text-slate-700 hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800 sm:w-auto"
          >
