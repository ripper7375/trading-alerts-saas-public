...
export function WatchlistWidget({
  ...
  return (
    <Card className="bg-white dark:bg-gray-800" data-testid="watchlist-widget-card">
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link href="/watchlist/add">
            <Button variant="outline" size="sm" data-testid="add-watchlist-item">
          ...
          {items.length > 0 && (
            <Link href="/watchlist">
              <Button
                ...
                data-testid="view-all-watchlist"
              >
                View All
      ...
      <CardContent className="pt-0">
        {displayItems.length > 0 ? (
          ...
          <div className="text-center py-8" data-testid="watchlist-empty">
            ...
            <Link href="/watchlist/add">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white" data-testid="add-symbol-button">
