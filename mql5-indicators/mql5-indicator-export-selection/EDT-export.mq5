...
#property description "Equal Distance Trendlines (EDT) based on S&R FL"
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "EDT Model");
   CreateExportButton();
...
void BuildEDTLines(const int rates_total, double current_close)
  {
   ...
   // Treat every fractal as a potential starting anchor for a parallel line
...
bool ExportEDTData()
  {
    ...
    string clean_symbol = symbol; int dot_pos = StringFind(clean_symbol, ".");
