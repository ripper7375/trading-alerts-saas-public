//+------------------------------------------------------------------+
//|                                       Single-Best-SR-FL-WP.mq5   |
//|                                  Copyright 2026, MetaQuotes Ltd. |
//|                                             https://www.mql5.com |
//| Description: Single Highest-Conviction S&R FL inside a Window    |
//+------------------------------------------------------------------+
#property copyright "Copyright 2026, MetaQuotes Ltd."
#property link      "https://www.mql5.com"
#property version   "1.00"
#property description "Single Highest-Conviction S&R FL within a strict Window Period"
...
//--- Enums
#define EXPORT_BUTTON_NAME "Single_FL_ExportBtn"
...
input color             InpBestFLColor = clrBlue;// Color for Best FL
...
input string            InpExportFileName = "Single_Best_FL";
...
double ExtBestFL[]; // Just ONE line buffer
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "Single Best S&R FL");
   CreateExportButton();
...
void CreateExportButton()
  {
    ...
    ObjectSetString(0, EXPORT_BUTTON_NAME, OBJPROP_TEXT, "Export Best FL");
...
void BuildBestFlipLine(const int rates_total)
  {
   ...
   // 2. Gather Fractals STRICTLY inside the window
   ...
   // Sort fractals chronologically for clean distance calculation
   ...
   for(int i = 0; i < f_count - 1; i++) {
      for(int j = i + 1; j < f_count; j++) {
         ...
         if(touches >= InpMinTouches && pass_flip_check) {
            ...
            // If this line is better than our reigning champion, overwrite it immediately
...
bool ExportSingleFLData()
  {
    ...
    // Export bounds align with the Window Period logic
