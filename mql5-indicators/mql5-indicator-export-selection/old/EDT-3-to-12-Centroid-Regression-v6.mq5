...
#property description "Combines SSA Clustering, Dynamic N-Centroid Regression (Up to 12), and Symmetrical EDT Snapping"
...
input int               InpRegCentroids = 3; // Number of Centroids for Regression (3 to 12)
...
int OnInit()
{
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "SSA Regression EDT V3.50");
...
void PerformClusteringAndEDT(const int rates_total, const datetime &time[], const double &close_arr[])
{
   ...
   // Safety Check: Clamp the user input between 3 and 12 mathematically
