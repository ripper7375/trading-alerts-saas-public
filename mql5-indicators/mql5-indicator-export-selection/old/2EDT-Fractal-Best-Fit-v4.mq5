...
//--- Enums
#define EXPORT_BUTTON_NAME "Single_FL_EDT_ExportBtn"
...
input datetime          InpStartDateTime = D'2024.01.01 00:00'; 
input datetime          InpEndDateTime   = D'2026.01.01 00:00'; 
...
void CreateExportButton()
  {
    ...
    ObjectSetString(0, EXPORT_BUTTON_NAME, OBJPROP_TEXT, "Export Lines");
...
bool ExportSingleFLData()
  {
    ...
    if(InpIncludeHeader) {
        string header = "timestamp\tsymbol\ttimeframe\tclose\tBest_FL\tUOEDT\tLOEDT";
