// Ported verbatim from lib/auth/two-factor.ts (Session 3-4, deferred out of
// Session 3-2 — see that order's Deviations #3). Pure crypto/TOTP logic, no
// framework imports, same porting discipline as auth/errors.ts: a full copy
// rather than a curated subset, so nothing downstream silently diverges (L4).
