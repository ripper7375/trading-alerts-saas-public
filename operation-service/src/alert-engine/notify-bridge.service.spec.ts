/**
 * Tests for the cross-process notify bridge: message build / parse
 * (publisher-side assertions only — the subscriber loop stays in the
 * monolith).
 *
 * Ported verbatim from __tests__/alert-engine/notify-bridge.test.ts
 * (Session 4B-2, File 11/13) — assertions unchanged.
 */
