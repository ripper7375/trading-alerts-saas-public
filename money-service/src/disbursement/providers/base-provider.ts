 ...
 *
 * Ported byte-for-byte from lib/disbursement/providers/base-provider.ts
 * (Session 4A-2, File 3/6). Abstract class defining the contract for all
 * payment providers. Implementations include MockPaymentProvider and (in a
 * later slice) RisePaymentProvider.
 */
