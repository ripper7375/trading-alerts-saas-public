 ...
 *
 * Ported byte-for-byte from lib/disbursement/providers/mock-provider.ts
 * (Session 4A-2, File 3/6). A mock implementation of the PaymentProvider
 * interface for testing and development purposes. Simulates payment
 * operations with configurable behavior including failure rates and delays.
 */

import { generateTransactionId } from '../disbursement.constants';
import type {
  AuthToken,
  PaymentRequest,
  PaymentResult,
