/**
 * RiseWorks Webhook Verifier
 *
 * Ported byte-for-byte from lib/disbursement/providers/rise/webhook-verifier.ts
 * (Session 4A-4, File 3/4). Verifies webhook signatures from RiseWorks using
 * HMAC-SHA256. The signature is provided in the x-rise-signature header.
 */
