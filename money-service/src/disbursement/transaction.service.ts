 ...
 *
 * Ported from lib/disbursement/services/transaction-service.ts (Session
 * 4A-2, File 3/6). Bridges Commission records with disbursement
 * transactions. Converted to `@Injectable()` with `PrismaService`
