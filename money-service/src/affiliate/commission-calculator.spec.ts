 ...
 * __tests__/lib/affiliate/commission-calculator.test.ts (Session 4A-4, File
 * 4/4). Assertions unchanged (parity oracle) — only the import path
 * changed. Covers the 4 pure functions only (the *WithDynamicConfig
 * wrappers have no source test coverage either — see this order's
 * Deviations).
 *
