/**
 * Admin P&L Calculator (Session 4A-6, File 2/3)
 *
 * Ported byte-for-byte from lib/admin/pnl-calculator.ts. Plain functions
 * (no DI in source, no Prisma/service dependency of its own) — same
 * treatment as affiliate/commission-calculator.ts.
 *
