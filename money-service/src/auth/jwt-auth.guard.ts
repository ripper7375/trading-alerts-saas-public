...
// Verifies NextAuth-issued session tokens — same hybrid-auth bridge as
// operation-service's JwtAuthGuard (F6/F7). Money-service reads the same
// NEXTAUTH_SECRET-derived key; it never writes/re-issues tokens.
@Injectable()
