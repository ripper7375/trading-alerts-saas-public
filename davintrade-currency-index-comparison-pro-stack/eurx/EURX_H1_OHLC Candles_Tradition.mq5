...
int OnInit()
{
    ...
    IndicatorSetString(INDICATOR_SHORTNAME, "EURX H1 Candles");
    
    // Get indicator handles
    handle_open = iCustom(Symbol(), Period(), "EURX_H1_Open", false, false);
    handle_high = iCustom(Symbol(), Period(), "EURX_H1_High", false, false);
    handle_low = iCustom(Symbol(), Period(), "EURX_H1_Low", false, false);
    handle_close = iCustom(Symbol(), Period(), "EURX_H1_Close", false, false);
                ...
                const int &spread[])
{
    ...
    for(int i = start; i < rates_total && !IsStopped(); i++)
    {
        ...
        HighBuffer[i] = high_price;
        LowBuffer[i] = low_price;
