...
#property indicator_label1  "XAUX HA"
...
int OnInit()
{
    ...
    IndicatorSetString(INDICATOR_SHORTNAME, "XAUX H1 Heiken Ashi");
                ...
                const int &spread[])
{
    ...
    for(int i = start; i < rates_total && !IsStopped(); i++)
    {
        ...
        // Calculate Heiken Ashi values
        double ha_close = (open_price + high_price + low_price + close_price) / 4.0;
        double ha_open = (i == 0) ? open_price : (HAOpenBuffer[i-1] + HACloseBuffer[i-1]) / 2.0;
