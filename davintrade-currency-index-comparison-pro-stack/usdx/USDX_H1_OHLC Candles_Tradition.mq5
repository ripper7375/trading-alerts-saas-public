...
int OnInit()
{
    ...
    IndicatorSetString(INDICATOR_SHORTNAME, "USDX H1 Candles");
    
    // Get indicator handles
    handle_open = iCustom(Symbol(), Period(), "USDX_H1_Open", false, false);
    handle_high = iCustom(Symbol(), Period(), "USDX_H1_High", false, false);
    handle_low = iCustom(Symbol(), Period(), "USDX_H1_Low", false, false);
    handle_close = iCustom(Symbol(), Period(), "USDX_H1_Close", false, false);
